...
def main():
    ...
    # Iterador zip
    print("\nPercorrendo listas de nomes e salários:")
    salarios.percorreComNomes(nomes)

    # Iterador map
    print("\nReajustando salários em 10%:")
    salariosReajustados = salarios.reajustaSalarios()
    print(salariosReajustados)

    # Iterador filter
    print("\nModificando datas anteriores a 2019:")
    datas.modificaDatasAnteriores()
    print(datas.listarEmOrdem())
